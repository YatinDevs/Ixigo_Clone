...
function UpdatedSearchPanel({ busJourneyDetails, setBusJourneyDetails }) {
  const [updatedInputData, setUpdatedInputData] = useState(busJourneyDetails);
  ...
  const handleUpdatedSearch = () => {
    ...
    setBusJourneyDetails(updatedInputData);
    ...
    setTimeout(() => {
      navigate(`/buses/searchBus/${dateParams}`, {
        state: { ...setBusJourneyDetails },
      });
    }, 200);
  };
  return (
