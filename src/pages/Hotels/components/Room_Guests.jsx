...
function Room_Guests({
  ...
  return (
    <div
      className={`text-left  relative border-2 rounded-md py-1 my-1 md:m-3 min-w-[200px] w-fit   hover:border-slate-500 cursor-pointer ${className} ${
        showMenu ? "border-orange-500" : ""
      } `}
      onClick={() => {
        setShowMenu(true);
      }}
