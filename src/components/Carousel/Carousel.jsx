...
import "./style.css";
import OfferCard from "../../pages/Flights/FlightsOffers/OfferCard";
  ...
  return (
    <div className="relative w-full mx-4 ">
      <ContentWrapper className="relative">
        <IoMdArrowBack
          className="carouselLeftNav arrow text-2xl text-black bg-white p-4 w-14 h-14 rounded-full absolute -translate-y-2/4 cursor-pointer z-[2] hidden top-[50%] md:block transition-all hover:scale-110 left-6 shadow-even"
